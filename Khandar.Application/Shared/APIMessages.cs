...
namespace Khandar.Application.Shared;

public static class APIMessages
{
    // Common Errors 
    public static readonly string LoginFirst = "Please Login First";

    public static readonly string TechnicalError = "There is some technical error, please try again later.";

    public static readonly string ProjectName = "eKhandar";
    ...
    public static readonly string VerifyEmailLink = "api/user/verifyemail";
    ...
    public static readonly string Templates = "D:\\Repository\\Khandar\\API\\khandar-Api\\khandar.Infrastructure\\EmailTemplates";
    ...
    public static readonly string WelomeEmailSubject = "Welcome to eKhandar";

    public static readonly string NotAuthorized = "You Are Not Authorized";
    ...
    public static class TemplateNames
    {
        ...
        public static readonly string WelcomeWithCredentials = "WelcomeWithCredentials.cshtml";
    }
