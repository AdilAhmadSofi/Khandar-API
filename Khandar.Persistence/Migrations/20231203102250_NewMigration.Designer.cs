...
namespace Khandar.Persistence.Migrations
{
    ...
    [Migration("20231203102250_NewMigration")]
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("6de15661-4d77-4235-80ba-02d51ae32e23"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 12, 3, 15, 52, 49, 872, DateTimeKind.Unspecified).AddTicks(6943), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("49399596-b617-4e16-b732-3e52cdf05fd0"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 12, 3, 15, 52, 49, 872, DateTimeKind.Unspecified).AddTicks(6961), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "rizwan"
                        });
