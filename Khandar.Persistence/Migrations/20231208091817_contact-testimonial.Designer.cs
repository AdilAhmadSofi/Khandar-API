...
namespace Khandar.Persistence.Migrations
{
    ...
    [Migration("20231208091817_contact-testimonial")]
    partial class contacttestimonial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.AnoymousDonor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.AppOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.AppPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.Testimonial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("d375ad27-371b-418d-8521-7ef422170e24"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 12, 8, 14, 48, 17, 552, DateTimeKind.Unspecified).AddTicks(4576), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("89063e0a-a55c-4e9e-a8d5-ba1f27133c2b"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 12, 8, 14, 48, 17, 552, DateTimeKind.Unspecified).AddTicks(4586), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "rizwan"
                        });
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.AppPayment", b =>
                {
                    b.HasOne("Khandar.Domain.Entities.AppOrder", "Order")
                        .WithMany("Payments")
