...
namespace Khandar.Persistence.Migrations
{
    ...
    [Migration("20231207184008_apporder")]
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("26eabe54-0841-4afc-a659-6286cdbf7a3d"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 12, 8, 0, 10, 8, 115, DateTimeKind.Unspecified).AddTicks(6124), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("bd4fecca-aa22-4cc2-aa40-4e8efad06963"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 12, 8, 0, 10, 8, 115, DateTimeKind.Unspecified).AddTicks(6141), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "rizwan"
                        });
