...
namespace Khandar.Persistence.Migrations
{
    ...
    [Migration("20231208142325_remove_Anonymous_entity")]
    partial class remove_Anonymous_entity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Khandar.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("38fc4a0f-b476-4dd0-9306-0d7f66ab0a77"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 12, 8, 19, 53, 24, 940, DateTimeKind.Unspecified).AddTicks(889), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            UpdatedBy = new Guid("cf24dc34-37b5-42cf-aa42-0a3dbecda0ac"),
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 12, 8, 19, 53, 24, 940, DateTimeKind.Unspecified).AddTicks(900), new TimeSpan(0, 5, 30, 0, 0)),
                            UserRole = 1,
                            UserStatus = 1,
                            Username = "rizwan"
                        });
