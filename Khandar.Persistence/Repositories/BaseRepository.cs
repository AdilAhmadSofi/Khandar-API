...
public class BaseRepository<T> : IBaseRepository<T> where T : BaseModel
{
    ...
    public BaseRepository(KhandarDbContext context)
    {
    ...
    public Task<T1> QueryMultiple<T1>(string sql, object? param, CommandType commandType = CommandType.Text, IDbTransaction? transaction = null)
    {
        throw new NotImplementedException();
    }
...
public static class DapperAsExtensionOnEfCore
{
    ...
    public static async Task<T?> QueryMultipleDapperExtentionMethod<T>(this DbContext context, string sql, object? param = default, CommandType commandType = CommandType.Text, IDbTransaction? transaction = null)
    {
        try
        {
            SqlConnection connection = new(context.Database.GetConnectionString());
            ...
            //{
            //    var countA = multi.Read<T>();
            //    var countB = multi.Read<T>();
            //    return multi.Read<T>();
            //}
